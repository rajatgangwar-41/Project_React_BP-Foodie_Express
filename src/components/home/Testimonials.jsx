  ...
  const scrollContent = () => {
    if (scrollContainerRef.current && !isUserInteracting.current) {
      ...
      if (container.scrollLeft >= maxScroll - 10) {
        // When near the end, reset to start for infinite effect
    ...
    <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-16">
      <div className="mb-10 text-center">
        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
          Customer <span className="text-orange-400">Testimonials</span>
        </h2>
      </div>
      ...
      <div className="relative">
        ...
        <div
          ...
          className="flex gap-4 sm:gap-6 overflow-x-auto pb-6 sm:pb-8 scrollbar-hide snap-x snap-mandatory"
        ...
        >
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className="flex-shrink-0 w-72 sm:w-80 md:w-96 rounded-xl shadow-lg hover:shadow-xl transition-all bg-white border border-gray-100"
            >
              <div className="p-4 sm:p-6">
                <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                  <img
                    alt={testimonial.name}
                    className="w-12 h-12 sm:w-16 sm:h-16 rounded-full object-cover border-2 sm:border-4 border-orange-100"
                  ...
                  <div className="ml-auto flex items-center bg-orange-500 text-white px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs sm:text-sm font-bold">
                ...
                <div className="relative pl-6 sm:pl-8">
                  <FaQuoteLeft className="text-orange-200 text-2xl sm:text-3xl absolute left-0 top-0" />
